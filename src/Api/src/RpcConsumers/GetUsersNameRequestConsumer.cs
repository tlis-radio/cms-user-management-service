...
internal class GetUsersNickNameRequestConsumer : BaseRpcConsumer<GetUsersNickNameRequest, GetUsersNickNameResponse>
{
    public GetUsersNickNameRequestConsumer(IServiceProvider serviceProvider, ObjectPool<IModel> channel)
        : base(serviceProvider, "user-management-service-rpc:get-users-nickname", channel)
    {
    }
